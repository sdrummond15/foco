...
<form action="<?php echo JRoute::_('index.php?option=com_courses&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="course-form" class="form-validate">
    ...
    <div class="form-personalizado">
        <div class="form-horizontal">
            ...
            <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_COURSE_NEW_COURSE', true) : JText::_('COM_COURSE_EDIT_COURSE', true)); ?>
            <div class="row-fluid">
                <div class="span12">
